...
class Main {
  ...
  */
  static void mostrarNotas() {
    ...
    System.out.printf("\n  Média Final = %.2f" , calcularMedia(notas));
  ...
  static void provaAI(double[] notas) {
      double notaAi = 0;
      int piorProva = notas[0] <= notas[1] ? 0 : 1; //Verifica a menor nota entre as 2 primeira notas.


      System.out.println("Digite A Nota Da Prova AI");
      notaAi = lerNota("Prova AI", NOTA_MAX_AVALIACOES[piorProva]);
